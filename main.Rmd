...
## The Difference in Lab & Wild genes for a given chromosome...
```{r}
given_chrom <- "chr06" ## The given chromosome...
mygeno <- genotype[, round(mean(which(marker$chrom==given_chrom)))]
